...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,accountNo,installmentAmount,termYears,termMonths,interestRate,customerId,schemeType,maturityAmount,startDate,maturityDate,linkedAutoDebitAccountNo,const DeepCollectionEquality().hash(nominees));

@override
String toString() {
  return 'RecurringDeposit(id: $id, accountNo: $accountNo, installmentAmount: $installmentAmount, termYears: $termYears, termMonths: $termMonths, interestRate: $interestRate, customerId: $customerId, schemeType: $schemeType, maturityAmount: $maturityAmount, startDate: $startDate, maturityDate: $maturityDate, linkedAutoDebitAccountNo: $linkedAutoDebitAccountNo, nominees: $nominees)';
}
...
@useResult
$Res call({
 String id, String accountNo, double installmentAmount, int termYears, int termMonths, double interestRate, String customerId, RecurringSchemeType schemeType, double maturityAmount, DateTime startDate, DateTime maturityDate, String? linkedAutoDebitAccountNo, List<Nominee> nominees
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String accountNo,  double installmentAmount,  int termYears,  int termMonths,  double interestRate,  String customerId,  RecurringSchemeType schemeType,  double maturityAmount,  DateTime startDate,  DateTime maturityDate,  String? linkedAutoDebitAccountNo,  List<Nominee> nominees)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecurringDeposit() when $default != null:
return $default(_that.id,_that.accountNo,_that.installmentAmount,_that.termYears,_that.termMonths,_that.interestRate,_that.customerId,_that.schemeType,_that.maturityAmount,_that.startDate,_that.maturityDate,_that.linkedAutoDebitAccountNo,_that.nominees);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String accountNo,  double installmentAmount,  int termYears,  int termMonths,  double interestRate,  String customerId,  RecurringSchemeType schemeType,  double maturityAmount,  DateTime startDate,  DateTime maturityDate,  String? linkedAutoDebitAccountNo,  List<Nominee> nominees)  $default,) {final _that = this;
switch (_that) {
case _RecurringDeposit():
return $default(_that.id,_that.accountNo,_that.installmentAmount,_that.termYears,_that.termMonths,_that.interestRate,_that.customerId,_that.schemeType,_that.maturityAmount,_that.startDate,_that.maturityDate,_that.linkedAutoDebitAccountNo,_that.nominees);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,accountNo,installmentAmount,termYears,termMonths,interestRate,customerId,schemeType,maturityAmount,startDate,maturityDate,linkedAutoDebitAccountNo,const DeepCollectionEquality().hash(_nominees));
