...
switch (_that) {
case _RecurringDeposit() when $default != null:
return $default(_that.id,_that.serialNo,_that.accountNo,_that.installmentAmount,_that.termYears,_that.termMonths,_that.interestRate,_that.customerId,_that.schemeType,_that.startDate,_that.nominees,_that.status,_that.createdAt,_that.updatedAt,_that.migrationSource);case _:
  return orElse();
...
switch (_that) {
case _RecurringDeposit():
return $default(_that.id,_that.serialNo,_that.accountNo,_that.installmentAmount,_that.termYears,_that.termMonths,_that.interestRate,_that.customerId,_that.schemeType,_that.startDate,_that.nominees,_that.status,_that.createdAt,_that.updatedAt,_that.migrationSource);}
}
