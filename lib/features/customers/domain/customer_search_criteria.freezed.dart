...
/// Adds pattern-matching-related methods to [CustomerSearchCriteria].
extension CustomerSearchCriteriaPatterns on CustomerSearchCriteria {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CustomerSearchCriteria value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CustomerSearchCriteria() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CustomerSearchCriteria value)  $default,){
final _that = this;
switch (_that) {
case _CustomerSearchCriteria():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CustomerSearchCriteria value)?  $default,){
final _that = this;
switch (_that) {
case _CustomerSearchCriteria() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String searchQuery,  CustomerSortOption sortBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerSearchCriteria() when $default != null:
return $default(_that.searchQuery,_that.sortBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String searchQuery,  CustomerSortOption sortBy)  $default,) {final _that = this;
switch (_that) {
case _CustomerSearchCriteria():
return $default(_that.searchQuery,_that.sortBy);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String searchQuery,  CustomerSortOption sortBy)?  $default,) {final _that = this;
switch (_that) {
case _CustomerSearchCriteria() when $default != null:
return $default(_that.searchQuery,_that.sortBy);case _:
  return null;
