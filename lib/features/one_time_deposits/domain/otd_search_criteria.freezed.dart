...
mixin _$OTDSearchCriteria {
 ...
 String get searchQuery; OTDSortField get sortField; SortDirection get sortDirection; List<DepositStatus> get statusFilters; List<MaturityUrgency> get urgencyFilters; List<OneTimeSchemeType> get schemeFilters;
...
@override
int get hashCode => Object.hash(runtimeType,searchQuery,sortField,sortDirection,const DeepCollectionEquality().hash(statusFilters),const DeepCollectionEquality().hash(urgencyFilters),const DeepCollectionEquality().hash(schemeFilters));

@override
String toString() {
  return 'OTDSearchCriteria(searchQuery: $searchQuery, sortField: $sortField, sortDirection: $sortDirection, statusFilters: $statusFilters, urgencyFilters: $urgencyFilters, schemeFilters: $schemeFilters)';
}
...
@useResult
$Res call({
 String searchQuery, OTDSortField sortField, SortDirection sortDirection, List<DepositStatus> statusFilters, List<MaturityUrgency> urgencyFilters, List<OneTimeSchemeType> schemeFilters
});
...
/// Create a copy of OTDSearchCriteria
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? searchQuery = null,Object? sortField = null,Object? sortDirection = null,Object? statusFilters = null,Object? urgencyFilters = null,Object? schemeFilters = null,}) {
...
as OTDSortField,sortDirection: null == sortDirection ? _self.sortDirection : sortDirection // ignore: cast_nullable_to_non_nullable
...
class _OTDSearchCriteria implements OTDSearchCriteria {
  const _OTDSearchCriteria({this.searchQuery = '', this.sortField = OTDSortField.maturityDate, this.sortDirection = SortDirection.asc, final  List<DepositStatus> statusFilters = const [DepositStatus.active], final  List<MaturityUrgency> urgencyFilters = const [], final  List<OneTimeSchemeType> schemeFilters = const []}): _statusFilters = statusFilters,_urgencyFilters = urgencyFilters,_schemeFilters = schemeFilters;
  

@override@JsonKey() final  String searchQuery;
@override@JsonKey() final  OTDSortField sortField;
...
@override
int get hashCode => Object.hash(runtimeType,searchQuery,sortField,sortDirection,const DeepCollectionEquality().hash(_statusFilters),const DeepCollectionEquality().hash(_urgencyFilters),const DeepCollectionEquality().hash(_schemeFilters));
...
/// Create a copy of OTDSearchCriteria
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? searchQuery = null,Object? sortField = null,Object? sortDirection = null,Object? statusFilters = null,Object? urgencyFilters = null,Object? schemeFilters = null,}) {
