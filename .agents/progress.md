...
None currently. The architectural cleanup phase, type-safe routing migration, UI updates (pull-to-refresh, AppDimensions in deposit cards), and mock CRUD implementations are complete. 
